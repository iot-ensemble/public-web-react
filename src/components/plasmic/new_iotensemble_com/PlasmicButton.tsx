...
import sty from "./PlasmicButton.module.css"; // plasmic-import: cDQxsDRfT9gIBv/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__dqP1)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__fBysl)}
                role={"img"}
              />
            ),
