...
import Footer from "../../Footer"; // plasmic-import: f2eb7w6yJRNUff/component
...
import sty from "./PlasmicHabistackFooter.module.css"; // plasmic-import: nHdjbLpYYfejjx/css
