...
import sty from "./PlasmicIconLink.module.css"; // plasmic-import: OMhvBSE1ZfsHJe/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__uCxFw)}
              role={"img"}
            />
          ),
