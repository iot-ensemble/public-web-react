...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: T4jGAKcf3m1n9_/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__tKjzl)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__yKkix)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__qGTtt)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__hDllb)}>
            {p.renderPlasmicSlot({
